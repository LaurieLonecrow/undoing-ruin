...
export default function Home() {
  return (
    ...
    <Text top={'150px'} color={"#F3F3E3"} width={'50%'} content={homeContent.description}/>
    </Container>
    ...
    <Container color>
    <HeaderImage position={'45% 25%'} url="https://res.cloudinary.com/lonecrow/image/upload/v1658857695/Undoing-Ruin/IMG_1893_uti9tr.jpg"/>
    <Text top={'100px'} color={"#F3F3E3"} width={'100%'} content={homeContent.lorem}/>
    </Container>
    </>
  );
}
